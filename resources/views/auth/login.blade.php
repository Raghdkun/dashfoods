                            ...
                            <div class="col-lg-6">
                                <div class="p-5">
                                    ...
                                    <form method="POST" action="{{ route('login') }}" class="user">
                                        ...
                                        <hr>
                                        {{-- <a href="{{ route('social.login', 'google') }}" class="btn btn-google btn-user btn-block">
                                            <i class="fab fa-google fa-fw"></i> Login with Google
                                        </a>
                                        <a href="{{ route('social.login', 'facebook') }}" class="btn btn-facebook btn-user btn-block">
